  ...
  <el-dialog v-model="dialogFormVisible" title="详情" width="600">
    <el-form :model="form" label-position="right" label-width="120px">
      ...
      <el-form-item label="预约人：">
        <el-input v-model="form.user_name" disabled autocomplete="off" />
      </el-form-item>
      ...
      <el-form-item label="驾驶时长（秒）">
        <el-input v-model="form.driving_time" disabled autocomplete="off" />
      </el-form-item>
...
<script setup lang="ts">
  ...
  defineOptions({ name: 'DriverRecordDetailDialog' })
